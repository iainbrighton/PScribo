...
function OutWordImage {
  ...
  process {
    ...
    [ref] $null = $docPr.SetAttribute('id', $Image.Id)
    [ref] $null = $docPr.SetAttribute('name', $Image.Text)
    [ref] $null = $docPr.SetAttribute('descr', $Image.Text)
    ...
    $graphic = $inline.AppendChild($XmlDocument.CreateElement('a', 'graphic',$xmlnsdrawing))
    $graphicData = $graphic.AppendChild($XmlDocument.CreateElement('a', 'graphicData',$xmlnsdrawing))
    ...
    [ref] $null = $cNvPr.SetAttribute('id', $Image.Id)
    [ref] $null = $cNvPr.SetAttribute('name', $Image.Text)
    [ref] $null = $cNvPr.SetAttribute('descr', $Image.Text)
    ...
    $blipFill = $pic.AppendChild($XmlDocument.CreateElement('pic', 'blipFill', $xmlnspicture))
    $blip = $blipFill.AppendChild($XmlDocument.CreateElement('a', 'blip',$xmlnsdrawing))
    [ref] $null = $blip.SetAttribute('embed', $xmlnsrelationships, $Image.RefId)
    [ref] $null = $blip.SetAttribute('cstate', 'print')
    $extLst = $blip.AppendChild($XmlDocument.CreateElement('a', 'extlst',$xmlnsdrawing))
    $ext = $extLst.AppendChild($XmlDocument.CreateElement('a', 'ext',$xmlnsdrawing))
    ...
    $srcRect = $blipFill.AppendChild($XmlDocument.CreateElement('a', 'srcRect',$xmlnsdrawing))
    $stretch = $blipFill.AppendChild($XmlDocument.CreateElement('a', 'stretch',$xmlnsdrawing))
    $fillRect = $stretch.AppendChild($XmlDocument.CreateElement('a', 'fillRect',$xmlnsdrawing))
                
    $spPr = $pic.AppendChild($XmlDocument.CreateElement('pic', 'spPr', $xmlnspicture))
    [ref] $null = $spPr.SetAttribute('bwMode', 'auto')
    $xfrm = $spPr.AppendChild($XmlDocument.CreateElement('a', 'xfrm',$xmlnsdrawing))
    $off = $xfrm.AppendChild($XmlDocument.CreateElement('a', 'off',$xmlnsdrawing))
    ...
    $null = $prstGeom.AppendChild($XmlDocument.CreateElement('a', 'avLst',$xmlnsdrawing))
      
    $noFill = $spPr.AppendChild($XmlDocument.CreateElement('a', 'noFill',$xmlnsdrawing))
                
    $ln = $spPr.AppendChild($XmlDocument.CreateElement('a', 'ln',$xmlnsdrawing))
    $noFill = $ln.AppendChild($XmlDocument.CreateElement('a', 'noFill',$xmlnsdrawing))
...
IF(-not (Test-path $filepath)){Throw ('No file found at {0}' -f $FilePath)}
Else{
